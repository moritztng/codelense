  ...
  return (
    <Row className="justify-content-center" style={{ marginBottom: '80px' }}>
      <Col className="col-10">
        <Row className="shadow rounded p-3 justify-content-center">
          <Col className="col-4">
            <Form.Control
              value={location}
              ...
              required={true}
              className={exploreClicked && location == '' ? 'is-invalid' : ''}
            />
          </Col>
          <Col>
...
function NotificationModal({ show, onClose }: any) {
  ...
  return (
    <>
      <Modal show={show} onHide={onClose} style={{ textAlign: 'start' }}>
